...
func main() {
  ...
  if S == "SUN" { fmt.Println(7) }
  if S == "MON" { fmt.Println(6) }
  if S == "TUE" { fmt.Println(5) }
  if S == "WED" { fmt.Println(4) }
  if S == "THU" { fmt.Println(3) }
  if S == "FRI" { fmt.Println(2) }
  if S == "SAT" { fmt.Println(1) }
}
